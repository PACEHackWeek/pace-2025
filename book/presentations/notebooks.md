# Code Tutorials, Demos, and other Notebooks
...
A selection of additional notebooks will be presented during the hackweek, when mentors will give an overview and highlights without walking through the whole notebook.
Those notebooks, and all the remaining notebooks below, demonstrate how to achieve a lot of common data processing tasks.
We encourage you to seek out the mentor who authored notebooks with any questions you have during the hackweek.
Recordings of the "code demo" sessions will be linked here as they become available.
